...
constexpr int GRAY_SENSOR_PINS[5] = {27, 33, 32, 35, 34};
// 灰度传感器触发阈值。
// 读数高于这个值就认为压到线了。
constexpr int GRAY_THRESHOLD = 4000;
...
constexpr int LEFT_MOTOR_PINS[2] = {13, 15};
constexpr int RIGHT_MOTOR_PINS[2] = {14, 25};

// 左右编码器引脚
constexpr int LEFT_ENCODER_PINS[2] = {16, 17};
constexpr int RIGHT_ENCODER_PINS[2] = {18, 19};
